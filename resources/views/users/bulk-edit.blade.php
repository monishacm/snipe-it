                            ...
                            <div class="col-sm-9">
                                <div class="checkbox">
                                    <label for="activated">
                                        ...
                                        {{ Form::radio('activated', '1', request()->old('activated'), ['aria-label'=>'activated']) }}  User is activated<br>
                                        {{ Form::radio('activated', '0', request()->old('activated'), ['aria-label'=>'activated']) }}  User is de-activated
