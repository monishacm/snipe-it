                ...
                <div class="box-body">
                    ...
                    <div class="col-md-11 col-md-offset-1">
                        ...
                        <div class="form-group {{ $errors->has('labels_per_page') ? 'error' : '' }}">
                            ...
                            <div class="col-md-9">
                                {{ Form::text('labels_per_page', request()->old('labels_per_page', $setting->labels_per_page), ['class' => 'form-control','style' => 'width: 100px;', 'aria-label'=>'labels_per_page']) }}
                        ...
                        <div class="form-group {{ $errors->has('labels_fontsize') ? 'error' : '' }}">
                            ...
                            <div class="col-md-2 form-group">
                                <div class="input-group">
                                    {{ Form::text('labels_fontsize', request()->old('labels_fontsize', $setting->labels_fontsize), ['class' => 'form-control', 'aria-label'=>'labels_fontsize']) }}
                        ...
                        <div class="form-group {{ $errors->has('labels_width') ? 'error' : '' }}">
                            ...
                            <div class="col-md-3 form-group">
                                <div class="input-group">
                                    {{ Form::text('labels_width', request()->old('labels_width', $setting->labels_width), ['class' => 'form-control', 'aria-label'=>'labels_width']) }}
                                    <div class="input-group-addon">{{ trans('admin/settings/general.width_w') }}</div>
                                </div>
                            </div>
                            <div class="col-md-3 form-group" style="margin-left: 10px">
                                <div class="input-group">
                                    {{ Form::text('labels_height', request()->old('labels_height', $setting->labels_height), ['class' => 'form-control', 'aria-label'=>'labels_height']) }}
                        ...
                        <div class="form-group {{ $errors->has('labels_display_sgutter') ? 'error' : '' }}">
                            ...
                            <div class="col-md-3 form-group">
                                <div class="input-group">
                                    {{ Form::text('labels_display_sgutter', request()->old('labels_display_sgutter', $setting->labels_display_sgutter), ['class' => 'form-control', 'aria-label'=>'labels_display_sgutter']) }}
                                    <div class="input-group-addon">{{ trans('admin/settings/general.horizontal') }}</div>
                                </div>
                            </div>
                            <div class="col-md-3 form-group" style="margin-left: 10px">
                                <div class="input-group">
                                    {{ Form::text('labels_display_bgutter', request()->old('labels_display_bgutter', $setting->labels_display_bgutter), ['class' => 'form-control', 'aria-label'=>'labels_display_bgutter']) }}
                        ...
                        <div class="form-group {{ $errors->has('labels_pmargin_top') ? 'error' : '' }}">
                            ...
                            <div class="col-md-3 form-group">
                                <div class="input-group" style="margin-bottom: 15px;">
                                    {{ Form::text('labels_pmargin_top', request()->old('labels_pmargin_top', $setting->labels_pmargin_top), ['class' => 'form-control', 'aria-label'=>'labels_pmargin_top']) }}
                                    <div class="input-group-addon">{{ trans('admin/settings/general.top') }}</div>
                                </div>
                                <div class="input-group">
                                    {{ Form::text('labels_pmargin_right', request()->old('labels_pmargin_right', $setting->labels_pmargin_right), ['class' => 'form-control', 'aria-label'=>'labels_pmargin_right']) }}
                                    <div class="input-group-addon">{{ trans('admin/settings/general.right') }}</div>
                                </div>
                            </div>
                            <div class="col-md-3 form-group" style="margin-left: 10px; ">
                                <div class="input-group" style="margin-bottom: 15px;">
                                    {{ Form::text('labels_pmargin_bottom', request()->old('labels_pmargin_bottom', $setting->labels_pmargin_bottom), ['class' => 'form-control', 'aria-label'=>'labels_pmargin_bottom']) }}
                                    <div class="input-group-addon">{{ trans('admin/settings/general.bottom') }}</div>
                                </div>
                                <div class="input-group">
                                    {{ Form::text('labels_pmargin_left', request()->old('labels_pmargin_left', $setting->labels_pmargin_left), ['class' => 'form-control', 'aria-label'=>'labels_pmargin_left']) }}
                        ...
                        <div class="form-group {{ $errors->has('labels_pageheight') ? 'error' : '' }}">
                            ...
                            <div class="col-md-3 form-group">
                                <div class="input-group">
                                    {{ Form::text('labels_pagewidth', request()->old('labels_pagewidth', $setting->labels_pagewidth), ['class' => 'form-control', 'aria-label'=>'labels_pagewidth']) }}
                                    <div class="input-group-addon">{{ trans('admin/settings/general.width_w') }}</div>
                                </div>
                            </div>
                            <div class="col-md-3 form-group" style="margin-left: 10px">
                                <div class="input-group">
                                    {{ Form::text('labels_pageheight', request()->old('labels_pageheight', $setting->labels_pageheight), ['class' => 'form-control', 'aria-label'=>'labels_pageheight']) }}
                                    <div class="input-group-addon">{{ trans('admin/settings/general.height_h') }}</div>
                                </div>
                            </div>
                            <div class="col-md-9 col-md-offset-3">
                            ...
                            <div class="col-md-9">
                                <div class="checkbox">
                                    <label for="labels_display_name">
                                        {{ Form::checkbox('labels_display_name', '1', request()->old('labels_display_name',   $setting->labels_display_name),['class' => 'minimal', 'aria-label'=>'labels_display_name']) }}
                                        {{ trans('admin/hardware/form.name') }}
                                    </label>
                                    <label for="labels_display_serial">
                                        {{ Form::checkbox('labels_display_serial', '1', request()->old('labels_display_serial',   $setting->labels_display_serial),['class' => 'minimal', 'aria-label'=>'labels_display_serial']) }}
                                        {{ trans('admin/hardware/form.serial') }}
                                    </label>
                                    <label for="labels_display_tag">
                                        {{ Form::checkbox('labels_display_tag', '1', request()->old('labels_display_tag',   $setting->labels_display_tag),['class' => 'minimal', 'aria-label'=>'labels_display_tag']) }}
                                        {{ trans('admin/hardware/form.tag') }}
                                    </label>
                                    <label for="labels_display_model">
                                        {{ Form::checkbox('labels_display_model', '1', request()->old('labels_display_model',   $setting->labels_display_model),['class' => 'minimal', 'aria-label'=>'labels_display_model']) }}
                                        {{ trans('admin/hardware/form.model') }}
                                    </label>
                                    <label for="labels_display_company_name">
                                        {{ Form::checkbox('labels_display_company_name', '1', request()->old('labels_display_company_name',   $setting->labels_display_company_name),['class' => 'minimal', 'aria-label'=>'labels_display_company_name']) }}
