                ...
                <div class="box-body">
                    ...
                    <div class="col-md-11 col-md-offset-1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                {{ Form::checkbox('auto_increment_assets', '1', request()->old('auto_increment_assets', $setting->auto_increment_assets),array('class' => 'minimal', 'aria-label'=>'auto_increment_assets')) }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                {{ Form::text('next_auto_tag_base', request()->old('next_auto_tag_base', $setting->next_auto_tag_base), array('class' => 'form-control', 'style'=>'width: 150px;', 'aria-label'=>'next_auto_tag_base')) }}
                        ...
                        <div class="form-group {{ $errors->has('auto_increment_prefix') ? 'error' : '' }}">
                            ...
                            <div class="col-md-7">
                                @if ($setting->auto_increment_assets == 1)
                                    {{ Form::text('auto_increment_prefix', request()->old('auto_increment_prefix', $setting->auto_increment_prefix), array('class' => 'form-control', 'style'=>'width: 150px;', 'aria-label'=>'auto_increment_prefix')) }}
                                    {!! $errors->first('auto_increment_prefix', '<span class="alert-msg" aria-hidden="true">:message</span>') !!}
                                @else
                                    {{ Form::text('auto_increment_prefix', request()->old('auto_increment_prefix', $setting->auto_increment_prefix), array('class' => 'form-control', 'disabled'=>'disabled', 'style'=>'width: 150px;', 'aria-label'=>'auto_increment_prefix')) }}
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('zerofill_count') ? 'error' : '' }}">
                            ...
                            <div class="col-md-7">
                                {{ Form::text('zerofill_count', request()->old('zerofill_count', $setting->zerofill_count), array('class' => 'form-control', 'style'=>'width: 150px;', 'aria-label'=>'zerofill_count')) }}
