                    ...
                    @if ($is_gd_installed)
                        <!-- qr code -->
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    {{ Form::checkbox('qr_code', '1', request()->old('qr_code', $setting->qr_code),array('class' => 'minimal', 'aria-label'=>'qr_code')) }}
                                    {{ trans('general.yes') }}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    {{ Form::checkbox('alt_barcode_enabled', '1', request()->old('alt_barcode_enabled', $setting->alt_barcode_enabled),array('class' => 'minimal', 'aria-label'=>'alt_barcode_enabled')) }}
                                    {{ trans('general.yes') }}
                                </div>
                            </div>
