               ...
               <div class="box-body">
                   ...
                   <div class="col-md-12">
                    ...
                    <div class="form-group {{ $errors->has('full_multiple_companies_support') ? 'error' : '' }}">
                        ...
                        <div class="col-md-9">
                            {{ Form::checkbox('full_multiple_companies_support', '1', request()->old('full_multiple_companies_support', $setting->full_multiple_companies_support),array('class' => 'minimal', 'aria-label'=>'full_multiple_companies_support')) }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {{ Form::checkbox('load_remote', '1', request()->old('load_remote', $setting->load_remote),array('class' => 'minimal')) }}
                    ...
                    <div class="form-group {{ $errors->has('login_note') ? 'error' : '' }}">
                        ...
                        <div class="col-md-9">
                            @if (config('app.lock_passwords'))
                                ...
                                <textarea class="form-control disabled" name="login_note" placeholder="If you do not have a login or have found a device belonging to this company, please call technical support at 888-555-1212. Thank you." rows="2" aria-label="login_note" readonly>{{ request()->old('login_note', $setting->login_note) }}</textarea>
                            ...
                            @else
                                <textarea class="form-control" name="login_note" aria-label="login_note" placeholder="If you do not have a login or have found a device belonging to this company, please call technical support at 888-555-1212. Thank you." rows="2">{{ request()->old('login_note', $setting->login_note) }}</textarea>
                                {!! $errors->first('login_note', '<span class="alert-msg" aria-hidden="true">:message</span>') !!}
                            @endif
                       ...
                       <div class="form-group {{ $errors->has('dashboard_message') ? 'error' : '' }}">
                           ...
                           <div class="col-md-9">
                               @if (config('app.lock_passwords'))
                                   ...
                                   <textarea class="form-control disabled" name="login_note" placeholder="If you do not have a login or have found a device belonging to this company, please call technical support at 888-555-1212. Thank you." rows="2" aria-label="dashboard_message" readonly>{{ request()->old('dashboard_message', $setting->login_note) }}</textarea>
                                   {!! $errors->first('dashboard_message', '<span class="alert-msg" aria-hidden="true">:message</span>') !!}
                                   <p class="help-block">{{ trans('general.lock_passwords') }}</p>
                               @else
                                   <textarea class="form-control" aria-label="dashboard_message" name="dashboard_message" rows="2">{{ request()->old('login_note', $setting->dashboard_message) }}</textarea>
                                   {!! $errors->first('dashboard_message', '<span class="alert-msg" aria-hidden="true">:message</span>') !!}
                               @endif
                               <p class="help-block">
                       ...
                       <div class="form-group {{ $errors->has('show_in_model_list') ? 'error' : '' }}">
                           ...
                           <div class="col-md-9">
                               {{ Form::checkbox('show_in_model_list[]', 'image', request()->old('show_in_model_list', $snipeSettings->modellistCheckedValue('image')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' )) }} {{ trans('general.image') }} <br>
                               {{ Form::checkbox('show_in_model_list[]', 'category', request()->old('show_in_model_list', $snipeSettings->modellistCheckedValue('category')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' )) }} {{ trans('general.category') }} <br>
                               {{ Form::checkbox('show_in_model_list[]', 'manufacturer', request()->old('show_in_model_list', $snipeSettings->modellistCheckedValue('manufacturer')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' )) }}  {{ trans('general.manufacturer') }} <br>
                               {{ Form::checkbox('show_in_model_list[]', 'model_number', request()->old('show_in_model_list', $snipeSettings->modellistCheckedValue('model_number')),array('class' => 'minimal', 'aria-label'=>'show_in_model_list' )) }} {{ trans('general.model_no') }}<br>
                           </div>
                       </div>
                       <!-- /.form-group -->
