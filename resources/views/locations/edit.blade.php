@extends('layouts/edit-form', [
    ...
    'formAction' => ($item != null && $item->id != null) ? route('locations.update', ['location' => $item->id]) : route('locations.store'),
])
...
<div class="form-group {{ $errors->has('currency') ? ' has-error' : '' }}">
    ...
    <div class="col-md-9{{  (\App\Helpers\Helper::checkIfRequired($item, 'currency')) ? ' required' : '' }}">
        {{ Form::text('currency', request()->old('currency', $item->currency), array('class' => 'form-control','placeholder' => 'USD', 'maxlength'=>'3', 'style'=>'width: 60px;', 'aria-label'=>'currency')) }}
