@extends('layouts/edit-form', [
    ...
    'formAction' => ($item != null && $item->id != null) ? route('categories.update', ['category' => $item->id]) : route('categories.store'),
])
...
<div class="form-group {{ $errors->has('category_type') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7 required">
        {{ Form::select('category_type', $category_types , request()->old('category_type', $item->category_type), array('class'=>'select2', 'style'=>'min-width:350px', 'aria-label'=>'category_type', $item->itemCount() > 0 ? 'disabled' : '')) }}
...
<div class="form-group {{ $errors->has('eula_text') ? 'error' : '' }}">
    ...
    <div class="col-md-7">
        {{ Form::textarea('eula_text', request()->old('eula_text', $item->eula_text), array('class' => 'form-control', 'aria-label'=>'eula_text')) }}
