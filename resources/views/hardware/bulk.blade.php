      ...
      <div class="box box-default">
        <div class="box-body">
          ...
          <div class="form-group {{ $errors->has('purchase_date') ? ' has-error' : '' }}">
            ...
            <div class="input-group col-md-3">
              <input type="date" class="datepicker form-control" data-date-format="yyyy-mm-dd" placeholder="Select Date" name="purchase_date" id="purchase_date" value="{{ request()->old('purchase_date') }}" arial-label="purchase_date">
          ...
          <div class="form-group {{ $errors->has('status_id') ? ' has-error' : '' }}">
            ...
            <div class="col-md-7">
              {{ Form::select('status_id', $statuslabel_list , request()->old('status_id'), array('class'=>'select2', 'style'=>'width:350px', 'aria-label'=>'status_id')) }}
        ...
        <!-- Update actual location  -->
          <div class="form-group">
            ...
            <div class="col-md-9">
                ...
                <label for="update_real_loc">
                  {{ Form::radio('update_real_loc', '1', request()->old('update_real_loc'), ['class'=>'minimal', 'aria-label'=>'update_real_loc']) }}
                  Update default location AND actual location
                </label>
                <br>
                <label for="update_default_loc">
                  {{ Form::radio('update_real_loc', '0', request()->old('update_real_loc'), ['class'=>'minimal', 'aria-label'=>'update_default_loc']) }}
          ...
          <div class="form-group {{ $errors->has('purchase_cost') ? ' has-error' : '' }}">
            ...
            <div class="input-group col-md-3">
              <span class="input-group-addon">{{ $snipeSettings->default_currency }}</span>
                <input type="text" class="form-control"  maxlength="10" placeholder="{{ trans('admin/hardware/form.cost') }}" name="purchase_cost" id="purchase_cost" value="{{ request()->old('purchase_cost') }}">
          ...
          <div class="form-group {{ $errors->has('order_number') ? ' has-error' : '' }}">
            ...
            <div class="col-md-7">
              <input class="form-control" type="text" maxlength="20" name="order_number" id="order_number" value="{{ request()->old('order_number') }}" />
          ...
          <div class="form-group {{ $errors->has('warranty_months') ? ' has-error' : '' }}">
            ...
            <div class="col-md-3">
              <div class="input-group">
                <input class="col-md-3 form-control" maxlength="4" type="text" name="warranty_months" id="warranty_months" value="{{ request()->old('warranty_months') }}" />
