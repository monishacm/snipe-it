@extends('layouts/edit-form', [
    ...
    'formAction' => ($item != null && $item->id != null) ? route('licenses.update', ['license' => $item->id]) : route('licenses.store'),
])
...
<div class="form-group {{ $errors->has('reassignable') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7 input-group">
        {{ Form::Checkbox('reassignable', '1', request()->old('reassignable', $item->id ? $item->reassignable : '1'),array('class' => 'minimal', 'aria-label'=>'reassignable')) }}
        {{ trans('general.yes') }}
    </div>
</div>
...
<div class="form-group {{ $errors->has('maintained') ? ' has-error' : '' }}">
    ...
    <div class="checkbox col-md-7">
        {{ Form::Checkbox('maintained', '1', request()->old('maintained', $item->maintained),array('class' => 'minimal', 'aria-label'=>'maintained')) }}
        {{ trans('general.yes') }}
    </div>
</div>
