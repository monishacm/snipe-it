<div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7">
        {{Form::text('address', request()->old('address', $item->address), array('class' => 'form-control', 'aria-label'=>'address')) }}
...
<div class="form-group {{ $errors->has('address2') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7 col-md-offset-3">
        {{Form::text('address2', request()->old('address2', $item->address2), array('class' => 'form-control', 'aria-label'=>'address2')) }}
...
<div class="form-group {{ $errors->has('city') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7">
    {{Form::text('city', request()->old('city', $item->city), array('class' => 'form-control', 'aria-label'=>'city')) }}
...
<div class="form-group {{ $errors->has('state') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7">
    {{Form::text('state', request()->old('state', $item->state), array('class' => 'form-control', 'aria-label'=>'state')) }}
