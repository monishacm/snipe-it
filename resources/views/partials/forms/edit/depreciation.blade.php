...
<div class="form-group {{ $errors->has('depreciation_id') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7">
        {{ Form::select('depreciation_id', $depreciation_list , request()->old('depreciation_id', $item->depreciation_id), array('class'=>'select2', 'style'=>'width:350px', 'aria-label'=>'depreciation_id')) }}
