...
<div class="form-group {{ $errors->has('status_id') ? ' has-error' : '' }}">
    ...
    <div class="col-md-7 col-sm-11{{  (\App\Helpers\Helper::checkIfRequired($item, 'status_id')) ? ' required' : '' }}">
        {{ Form::select('status_id', $statuslabel_list , request()->old('status_id', $item->status_id), array('class'=>'select2 status_id', 'style'=>'width:100%','id'=>'status_select_id', 'aria-label'=>'status_id')) }}
